...
{
    /// <inheritdoc />
    public partial class Initialized_Created : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppIdentityId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StringContent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    AppUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "AppUserComments",
                columns: table => new
                {
                    AppUserCommnetId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserComments", x => x.AppUserCommnetId);
                    table.ForeignKey(
                        name: "FK_AppUserComments_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "AppUserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserComments_Comments_CommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserComments_AppUserId",
                table: "AppUserComments",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserComments_CommentId",
                table: "AppUserComments",
                column: "CommentId");
